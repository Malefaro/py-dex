...
from web3 import WebSocketProvider, AsyncWeb3, eth
from eth_abi.abi import decode

"""contract abi can be found at etherscan at contract tab
for example: https://etherscan.io/address/0x11b815efB8f581194ae79006d24E0d814B7697F6#code
"""
CONTRACT_ABI = """
...
async def subscribe_to_transfer_events(url, pool_address):
    ...
    pool_contract = w3.eth.contract(address=pool_address, abi=CONTRACT_ABI)

    # describe event:
    # <Name>([types of arguments])
    # it can be found at etherscan in contract events:
    # https://etherscan.io/address/0x11b815efB8f581194ae79006d24E0d814B7697F6#events
    swap_event_sig = w3.keccak(
        text="Swap(address,address,int256,int256,uint160,uint128,int24)"
    )
    # specify events that you will parse
    events_to_subscribe = [swap_event_sig]
    filter_params = {
        "address": pool_address,
        # topics can be omitted in which case all events will be sent
        "topics": events_to_subscribe,
    }
    ...
    async for payload in w3.socket.process_subscriptions():
        ...
        event_name_sig = result["topics"][0]
        ...
        match idx:
            case 0:
                ...
                parsed = pool_contract.events.Swap().process_log(result)
                print("parsed:", parsed)
...
if __name__ == "__main__":
    ...
    asyncio.run(subscribe_to_transfer_events(infura_url, pool_addr))
    pass
